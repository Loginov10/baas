...
--lisame vanusepiirangu ja kui sisestame uue isiku, tekib viga
alter table Person
...
--näitab inimesi, kellel on tähed W A S
select * from Person where Name like '[^WAS]%'
--- näitab inimesi, kelle limm on Gotham või New York ja vanus üle 40
...
--inimeste sorteerimine nende vanuse järgi
...
---näitab nimi ja department id
select distinct Name, DepartmentId from Employees

---arvutab töötajale palgad 
...
--näitab konkreetsest soost töötajate arvu
...
---loo protseduur,mis arvutab tabelis olevate töötajate koguarv
...
--- loo protseduur, mis näitab töötajat tema id järgi
...
--käivitame protseduur identifikaatoriga 6, mille annate sisendparameetrina üle, ja salvestame töötaja nimi @FristName
declare @FirstName nvarchar(50)
execute spGetNameById1 6, @FirstName output
print 'Name of the employee = ' + @FirstName

--loo protseduur, mis näitab nime tabelist id järgi
